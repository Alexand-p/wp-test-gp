...
add_action( 'wp_enqueue_scripts', 'mytemplate_frontend', 25 );
 
function mytemplate_frontend() {
 	wp_enqueue_style( 'mytemplate', get_stylesheet_directory_uri() . '/assets/css/mytemplate.css' );
}
